app.controller("GoalBasedAdviceController", ['$scope', '$state', function($scope, $state) {
        ...
        
   {
    ...
    text:"When something happens, like getting sick or injured, you still need to cover the important things like your household expenses andloan repayments",
